...
7. **Natural speech.** Split rather than accelerate. Dialogue-risk panels cannot advance until every source bubble is mapped or explicitly justified as omitted and the target shot has enough time. After every spoken or narrated sentence add `（音色、语气、情绪；必要时语速、停顿、重音）`.
