...
Read this file for fights or complex fast action. `storyboard-spec.md` remains authoritative: combat polish cannot manufacture an unsupported attack, route, grip, contact, injury, recovery, or result.
...
4. 【接触瞬间·极短慢镜】刀锋切入巨兽胸前甲壳，紧凑黑白冲击帧后出现椭圆压力环；甲壳裂纹从接触点定向扩开，较大的碎片先飞出，细尘随后涌起，镜头只在命中时轻震并迅速稳定。
