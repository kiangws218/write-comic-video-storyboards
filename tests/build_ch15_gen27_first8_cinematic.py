...
confrontation = shot(3, 1, 6, "ch15_p03_c001.jpg",
    ...
    "35mm贴地双人中近景，青的大头部前景与春子的侧脸后景形成强纵深；镜头极缓向右横移并保留上下压迫关系。",
...
ground_face = shot(3, 2, 6, "ch15_p03_c002.jpg",
    ...
    "100mm贴地脸部特写，焦平面锁在青的眼睑、泪滴和抿住的嘴唇；后景春子压成柔化遮挡，镜头只作极慢前推。",
...
crystal_explanation = shot(6, 1, 9, "ch15_p05_c002.jpg",
    ...
    "100mm物件特写，晶石略向右倾；固定构图中先锁内部星屑，再沿棱面缓慢拉焦到粗糙底座，后半句极轻推近。",
...
weapon_concept = shot(13, 1, 10, "ch15_p08_c001.jpg",
    ...
    "70mm说明性物件镜头，略高视角保持晶石与指虎完整并置；焦点从晶体内部沿冷白亮线横移到指虎四孔，后半段极缓推近两件物体的中心关系。",
...
SHOTS = [
    ...
    base.SHOTS[8], base.SHOTS[9], crystal_explanation, dwarf_offer,
    base.SHOTS[14], offer, crystal_in_palm,
    base.SHOTS[17], base.SHOTS[18], dwarf_long, weapon_concept, final_question,
]
