...
Read this file for fights or complex fast action. `source-grounding.md` remains authoritative: combat polish cannot manufacture an unsupported attack, route, grip, contact, injury, recovery, or result. Use `cinematic-quality.md` for the shared rhythm and effects quality floor.
